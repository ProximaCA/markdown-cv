# **Product Engineer & Fullstack разработчик**

## О себе

Fullstack инженер с Т‑Shaped профилем и опытом 4 лет разработки ПО: от веб сайтов, серверных архитектур, автоматизации, AI агентов и web3 приложений (dapps). Product-oriented Founder с инженерным бэкграундом. Превращаю идеи в масштабируемые продукты.
Особое внимание уделяю AIагентам, масштабируемой серверной логике, автоматизации с гибким подходом (smart). Работаю в режиме ускоренной разработки (vibe coding) shipping products fast: от идеи к рабочему прототипу за минимальные сроки, с последующей доработкой до продакшен качества.
...
* **Telegram:** [https://t.me/lucipure](https://t.me/lucipure)
...
## **Tonify — Founder & CEO/CTO/CPO*

2025 — настоящее время  
Музыкальная платформа в Telegram + TON с элементами геймификации и моделью Music‑to‑Earn.
...
* Спроектировал и запустил MVP музыкального стриминга внутри Telegram (TWA), обеспечив нативную интеграцию для бесшовного онбординга пользователей
* Разработал экономику внимания (Music-to-Earn): геймифицированная система вознаграждений для повышения Retention и вовлеченности (Daily Active Users):
...
* Обеспечил отказоустойчивую потоковую передачу медиа с минимальной задержкой (Low-latency streaming infrastructure)
...
* Автоматизировал сложный процесс генерации контента, сократив время создания кейсов в 100 раз
