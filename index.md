...
Fullstack‑инженер с Т‑Shaped профилем и опытом более 3 лет разработки ПО: от веб‑сайтов, серверных архитектур, автоматизации, AI‑агентов и web3 приложений (dapps). Product-oriented Founder с инженерным бэкграундом. Превращаю идеи в масштабируемые продукты.
Особое внимание уделяю AI‑агентам, масштабируемой серверной логике, автоматизации. Работаю в режиме ускоренной разработки (vibe coding) shipping products fast: от идеи к рабочему прототипу за минимальные сроки, с последующей доработкой до продакшен‑качества.
...
* **Telegram:** [https://t.me/proximaca](https://t.me/proximaca)
