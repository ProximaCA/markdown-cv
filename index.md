...
Fullstack‑инженер с Т‑Shaped профилем и опытом более 3 лет разработки ПО: от веб‑сайтов, серверных архитектур, автоматизации, AI‑агентов и web3 приложений (dapps). Умею вести проекты от первоначальной идеи до MVP с продуманной архитектурой, чистым кодом.
